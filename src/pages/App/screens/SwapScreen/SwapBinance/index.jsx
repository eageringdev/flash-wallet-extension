...
import { SwapConfirmBinance } from '../SwapConfirm';
...
import { swapTokenBnb } from '../../../../Background/store/actions/SwapActionsBnb';
...
const SwapBinance = ({
  ...
  const [gasPrice, setGasPrice] = useState(
    feeData && feeData.medium ? feeData.medium.gasPrice : undefined
  );
...
export default connect(mapStateToProps, mapDispatchToProps)(SwapBinance);
