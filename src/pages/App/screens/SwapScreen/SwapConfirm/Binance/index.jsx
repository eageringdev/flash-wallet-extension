...
const SwapConfirmBinance = ({
  ...
  const totalFee =
    parseFloat(utils.formatEther(gasPrice)) * parseFloat(gasLimit);
...
export default connect(mapStateToProps, mapDispatchToProps)(SwapConfirmBinance);
