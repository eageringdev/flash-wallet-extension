...
import { NetworkFeeBinanceModal } from '../../../components/NetworkFeeModal';
...
const SendTokenBinance = ({
  ...
  useEffect(() => {
    if (!feeData.low || !feeData.low.gasPrice) {
      return;
    }
    ...
    return (
      <div className="h-100 d-flex flex-column">
        ...
        <div className="mt-4 mr-1 d-flex flex-row align-items-center">
          ...
          <Button
            disabled={!(feeData.high && feeData.high.gasPrice)}
          ...
          >
            <div
              ...
              style={{
                ...
                color: !(feeData.high && feeData.high.gasPrice)
                  ? colors.grey9
                  : colors.primary5,
              }}
            >
...
export default connect(mapStateToProps, mapDispatchToProps)(SendTokenBinance);
